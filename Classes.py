class Char:
    ...
    def __str__(self):
        return "This is {},\nhis damage with 1 = {},\nhis damage with 2 = {},\nhis damage with 3 = {},\nhis damage with 4 = {},\nhis damage with 5 = {},\nand his damage with 6 = {}".format(
                self.name, self.n1, self.n2, self.n3, self.n4, self.n5, self.n6)
...
# print(Dexter) # Testing.


# Deprecated Player Class, future reference.
# class Player:
...
# Deprecated Player function, in favour of node lists.
# list = []
#
#
# def Players():
